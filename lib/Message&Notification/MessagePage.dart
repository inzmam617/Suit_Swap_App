        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              height: 30,
              width: 60,
              child: Center(child: Text("ALL",style: TextStyle(color: Colors.black,fontSize: 10),)),
            ),
            SizedBox(width: 5,),
            Container(
              decoration: BoxDecoration(
              ...
              height: 30,
              width: 60,
              child: Center(child: Text("READ",style: TextStyle(color: Colors.grey,fontSize: 10),)),
            ),
            SizedBox(width: 5,),
            Container(
              decoration: BoxDecoration(
              ...
              height: 30,
              width: 60,
              child: Center(child: Text("Unread",style: TextStyle(color: Colors.grey,fontSize: 10),)),
            ),
          ],
        ),
      ),
